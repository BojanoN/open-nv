...
\t| <a href="enum_list.html">Enum Types</a> | <a href="basic_list.html">Basic Types</a> | <a href="bitfield_list.html">Bitfield Types</a> | <a href="version_list.html">File Versions</a></p>
\t{contents}
</body>
</html>"""
...
<p>{count}</p>
<h3>Is integral type</h3>
<p>{integral}</p>
<h3>Can be used as boolean</h3>
<p>{boolean}</p>
<h3>Is convertible to</h3>
<p>{convertible}</p>
""" + FOUND_IN
...
COMPOUND = BLOCK + TYPE_SIZE + CONVERTIBILITY + FOUND_IN
NIOBJECT = BLOCK + PARENT_OF
COMPOUND_NO_META = BLOCK_NM + TYPE_SIZE + CONVERTIBILITY + FOUND_IN
...
\t<td>{member_name}</td>
\t<td>{member_mask}</td>
\t<td><a href ="{member_type}.html">{member_type}</a></td>

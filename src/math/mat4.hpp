...
inline void mat4_diag(mat4 mat, double val)
{
    mat[0][1] = 0.;
    mat[0][2] = 0.;
    mat[0][3] = 0.;
...
inline void mat4_scale(mat4 mat, double val)
{
    mat[0][0] *= val;
    mat[0][1] *= val;
    mat[0][2] *= val;
...
inline double mat4_det(mat4 mat)
{
    double m00 = mat[0][0];
    double m01 = mat[0][1];
    double m02 = mat[0][2];
...
inline void mat4_inv(mat4 mat)
{
    ...
    double det = 1.0f / (m00 * mat[0][0] + m01 * mat[1][0] + m02 * mat[2][0] + m03 * mat[3][0]);

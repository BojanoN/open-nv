...
inline void vec2_addc(vec2 a, vec2 dst, float val)
{
    dst[0] = a[0] + val;
    dst[1] = a[1] + val;
}
...
inline void vec2_subc(vec2 a, vec2 dst, float val)
{
    dst[0] = a[0] - val;
    dst[1] = a[1] - val;
}
...
inline void vec2_mulc(vec2 a, vec2 dst, float val)
{
    dst[0] = a[0] * val;
    dst[1] = a[1] * val;
}
...
inline void vec2_divc(vec2 a, vec2 dst, float val)
{
    dst[0] = a[0] / val;
    dst[1] = a[1] / val;
}
